...
class CantonDropdownButtonWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final cantonNotifier = ref.watch(cantonFutureProvider(ubicacionNotifier.provinciaSeleccionada!.id));
    ...
    return cantonNotifier.when(
        data: (cantones) {
          return DropdownButton<Canton>(
            ...
            onChanged: (canton) {
              ref.read(ubicacionProvider.notifier).changeCantonSeleccionadoSatate(canton!);
            },
            items: cantones
