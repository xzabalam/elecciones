...
class ConcejalesUrbanosUbicacionWidget extends ConsumerWidget {
  const ConcejalesUrbanosUbicacionWidget({
    Key? key,
  }) : super(key: key);
          ...
          child: AdaptiveButton(
            ...
            onPressed: () async {
              ...
              List<VotosMovimientoDto> respuestaSumatoriaVotosPorMovimiento =
                  await ref.read(numeroVotosParaConcejalesUrbanosPorProvinciaYCantonFutureProvider(parametros).future);
