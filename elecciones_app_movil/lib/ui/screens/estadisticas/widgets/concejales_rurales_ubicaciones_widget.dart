...
class ConcejalesRuralesUbicacionWidget extends ConsumerWidget {
  const ConcejalesRuralesUbicacionWidget({
    Key? key,
  }) : super(key: key);
          ...
          child: AdaptiveButton(
            ...
            onPressed: () async {
              ...
              List<VotosMovimientoDto> respuestaSumatoriaVotosPorMovimiento =
                  await ref.read(numeroVotosParaConcejalesRuralesPorProvinciaYCantonFutureProvider(parametros).future);
