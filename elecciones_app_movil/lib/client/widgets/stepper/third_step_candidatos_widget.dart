...
import 'package:elecciones_app_movil/client/widgets/candidatos/candidatos_widget.dart';
    ...
    return SafeArea(
      child: Column(
        ...
        children: [
          ...
          if (dignidadProvider.posicionDignidadSeleccionada != null)
            CandidatosStatefullWidget()
        ],
      ),
    );
  }
