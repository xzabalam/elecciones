...
class UbicacionNotifier extends StateNotifier<UbicacionModel> {
  ...
  void changeProvinciaSeleccionadaSatate(Provincia provincia) {
    state = UbicacionModel(paisSeleccionado: state.paisSeleccionado, provinciaSeleccionada: provincia);
  }
...
final ubicacionProvider = StateNotifierProvider<UbicacionNotifier, UbicacionModel>((ref) {
